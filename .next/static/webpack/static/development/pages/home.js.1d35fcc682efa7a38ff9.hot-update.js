...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Component, [{
    ...
    value: function componentDidMount() {
      ...
      console.log(loadDataArticle2);
      loadDataArticle2(page, totalArticle); // if (!dataArticles){
      //   if (!this.props.dataArticles) return null;
      //   this.setState({dataArticles:dataArticles});
      // }else{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          totalArticle = _this$props3.totalArticle; // if (dataArticles.length == 0) return (
...
//# sourceMappingURL=home.js.1d35fcc682efa7a38ff9.hot-update.js.map